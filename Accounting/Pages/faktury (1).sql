...
--
-- Host: 127.0.0.1
-- Czas generowania: 20 Kwi 2024, 09:01
...
INSERT INTO `fx` (`ID`, `Nr_Faktury`, `Data_wystawienia`, `Metoda_platnosci`, `Waluta`, `Cena_netto`, `Stawka_VAT`, `ID_wystawiajacy`, `ID_podmiot`, `Nazwa_towaru`, `Ilość`, `Termin_platnosci`) VALUES
...
INSERT INTO `user` (`ID`, `UserName`, `Password`, `Acces`) VALUES
(1, 'user1', 'pass1', 0),
(2, 'user2', 'pass2', 0);
